-- Migration: Add user name_short columns for costs approval/rejection to v_orders_visits
-- Date: 2026-09-11
...
-- Recreate v_orders_visits with new columns
...
-- Recreate v_orders_visits_assets (depends on v_orders_visits)
