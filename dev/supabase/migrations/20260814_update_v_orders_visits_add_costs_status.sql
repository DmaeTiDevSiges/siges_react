-- Migration: Atualizar view v_orders_visits para incluir campos de aprovação financeira
-- Data: 2026-08-14
-- Descrição: Adiciona campos de aprovação financeira à view v_orders_visits

-- ============================================================
-- 1. ATUALIZAR VIEW v_orders_visits
-- ============================================================
...
WITH ov AS (
    SELECT orders_visits_1.id,
        ...
        -- Novos campos de aprovação financeira
        orders_visits_1.ov_costs_status,
        orders_visits_1.ov_costs_submitted_at,
        orders_visits_1.ov_costs_submitted_user_id,
...
SELECT orders_visits.id,
    ...
    orders_visits.ov_costs_submitted_at,
    orders_visits.ov_costs_submitted_user_id,
...
-- ============================================================
-- 2. RECRIAR VIEW v_orders_visits_assets
-- ============================================================
-- O DROP ... CASCADE acima destrói a v_orders_visits_assets, que
-- depende de v_orders_visits. Ela precisa ser recriada para a aba
-- de ativos da visita continuar funcionando.
