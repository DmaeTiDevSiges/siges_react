-- ============================================================================
-- FIX: Recriar view v_orders_visits_assets
-- Motivo: a migration 20260814_update_v_orders_visits_add_costs_status.sql
--   executou DROP VIEW IF EXISTS public.v_orders_visits CASCADE, que destruiu a
--   v_orders_visits_assets (dependente de v_orders_visits). Esta view é usada
--   pela aba de ativos da visita técnica.
