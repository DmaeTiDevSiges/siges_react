-- Migration: Add signer name columns to assets_loans
-- Date: 2026-09-16
-- The signer for delivery can be different from return

-- 1. Add signer name columns
ALTER TABLE assets_loans
    ADD COLUMN IF NOT EXISTS signature_delivery_signer_name VARCHAR(255) DEFAULT NULL,
    ADD COLUMN IF NOT EXISTS signature_return_signer_name VARCHAR(255) DEFAULT NULL;

-- 2. Recreate view to include new columns
