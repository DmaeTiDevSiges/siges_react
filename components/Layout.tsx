  ...
  return (
    <div className="flex h-screen w-full bg-background-light dark:bg-background-dark overflow-hidden relative">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <main ref={mainRef} className={`flex-1 ${isDashboard ? 'overflow-hidden' : 'overflow-y-auto'} no-scrollbar ${hidePadding ? 'pb-0 md:pb-0' : 'pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-6'} relative`}>
          {loading && (
