...
```mermaid
flowchart TD
    step1([Acessar Tela Detalhes da Visita])
    step2[Responder ao Modal de Confirmacao]
    step3[Encerrar Visita]
...
sequenceDiagram
    ...
    S->>S: Acessar Tela Detalhes da Visita
...
stateDiagram-v2
    [*] --> Início
    Início --> Estado1: Acessar Tela Detalhes da Visita
    Estado1 --> Estado2: Responder ao Modal de Confirmacao
    Estado2 --> Estado3: Encerrar Visita
