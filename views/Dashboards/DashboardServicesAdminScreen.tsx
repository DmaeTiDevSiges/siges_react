...
interface DashboardServicesAdminScreenProps {
...
export const DashboardServicesAdminScreen: React.FC<DashboardServicesAdminScreenProps> = ({ currentUser, onSelectOrder, onResumeVisit, onEdit, onBack }) => {
    // Persistence keys
    const STORAGE_KEYS = {
