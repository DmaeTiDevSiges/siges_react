...
export const AssetTypesList: React.FC<AssetTypesListProps> = ({ onSelect, onAdd }) => {
    ...
    const [items, setItems] = useState<AssetType[]>(listCache?.items || []);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                setError(null);
                const data = await dataService.getAssetTypes(statusFilter, debouncedSearch);
                setItems(data);
            } catch (error) {
                                ...
                                <div className="flex items-center justify-between gap-2">
                                    ...
                                    <div
                                        onClick={async (e) => {
                                            ...
                                            try {
                                                await dataService.updateAssetType(item.id, { isAvailable: newStatus });
                                            } catch (error) {
