...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess, isDarkMode, onThemeToggle }) => {
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-end">
                            <button type="button" className="text-primary text-sm font-semibold hover:text-blue-600 dark:hover:text-blue-400 transition-colors focus:outline-none">
                                Esqueceu a senha?
                            </button>
                        </div>
                    </div>
