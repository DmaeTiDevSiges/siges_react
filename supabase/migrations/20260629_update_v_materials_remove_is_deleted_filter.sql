...
SELECT
    ...
    m.created_at,
    m.updated_at,
    -- Status do material (ativo/inativo/descontinuado)
    m.status_id,
...
-- Comentários na view
COMMENT ON VIEW public.v_materials IS 'Catálogo de materiais com status e resumo de estoque por almoxarifado';
