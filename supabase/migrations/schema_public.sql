...
DROP FUNCTION IF EXISTS public.fc_assets_search_type;
...
DROP FUNCTION IF EXISTS public.fc_assets_search_unit;
...
DROP FUNCTION IF EXISTS public.fc_assets_searchable;
...
DROP FUNCTION IF EXISTS public.fc_assets_searchable_update();
...
DROP FUNCTION IF EXISTS public.fc_cfg_units_assets_tags_set_last_values_when_processing_2();
...
DROP FUNCTION IF EXISTS public.fc_check_user_permission;
...
DROP FUNCTION IF EXISTS public.fc_contracts_services_search;
...
DROP FUNCTION IF EXISTS public.fc_dash_admin_orders_filters_open;
...
DROP FUNCTION IF EXISTS public.fc_materials_search;
...
DROP FUNCTION IF EXISTS public.fc_materials_searchable();
...
DROP FUNCTION IF EXISTS public.fc_order_counter_increment;
...
DROP FUNCTION IF EXISTS public.fc_orders_replace_special_chars();
...
DROP FUNCTION IF EXISTS public.fc_orders_types_activities_search;
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_assets_activities_description();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_assets_materials_update_value_total();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_assets_update_materials_value();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_services_amount_update();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_services_update_services_value();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_services_update_value_unit();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_teams_update();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_vehicles_amount_update();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_vehicles_update_value_unit();
...
DROP FUNCTION IF EXISTS public.fc_orders_visits_vehicles_update_vehicles_value();
...
DROP FUNCTION IF EXISTS public.fc_tgr_units_searchable();
...
DROP FUNCTION IF EXISTS public.fc_tm_assets_types_search_terms;
...
DROP FUNCTION IF EXISTS public.fc_units_assets_tags_available_rate_search_filters;
...
DROP FUNCTION IF EXISTS public.fc_units_assets_tags_search_filters;
...
DROP FUNCTION IF EXISTS public.fc_units_search;
...
DROP FUNCTION IF EXISTS public.fc_units_search_filters;
...
DROP FUNCTION IF EXISTS public.fc_update_profile_routes;
...
DROP FUNCTION IF EXISTS public.fc_users_search;
...
DROP FUNCTION IF EXISTS public.handle_notifications_count();
...
DROP FUNCTION IF EXISTS public.handle_profile_photo_change_notification();
...
DROP FUNCTION IF EXISTS public.handle_unit_description_full();
...
DROP FUNCTION IF EXISTS public.fc_financial_orders_visits_materials_sum;
...
DROP FUNCTION IF EXISTS public.fc_financial_orders_visits_services_sum;
...
DROP FUNCTION IF EXISTS public.fc_financial_orders_visits_vehicles_sum;
...
--
-- Name: warehouses_materials; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.warehouses_materials (
    ...
    CONSTRAINT warehouses_materials_warehouse_id_material_id_key UNIQUE (warehouse_id, material_id)
);

ALTER TABLE public.warehouses_materials OWNER TO postgres;

--
-- Name: warehouses_materials_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.warehouses_materials ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.warehouses_materials_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: warehouses_materials_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_warehouses_department_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warehouses_department_id ON public.warehouses(department_id);

--
-- Name: idx_warehouses_is_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_warehouses_is_deleted ON public.warehouses(is_deleted);

--
-- Name: idx_wm_warehouse_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wm_warehouse_id ON public.warehouses_materials(warehouse_id);

--
-- Name: idx_wm_material_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wm_material_id ON public.warehouses_materials(material_id);

--
-- Name: idx_wm_low_stock; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wm_low_stock ON public.warehouses_materials(quantity, min_stock) WHERE (quantity <= min_stock);

--
-- Name: warehouses_materials warehouses_materials_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: warehouses_materials warehouses_materials_material_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: warehouses_materials warehouses_materials_updated_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: warehouses warehouses_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.warehouses
    ADD CONSTRAINT warehouses_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.cfg_departments(id) ON DELETE SET NULL;

--
-- Name: warehouses warehouses_created_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.warehouses
    ADD CONSTRAINT warehouses_created_user_id_fkey FOREIGN KEY (created_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

--
-- Name: warehouses warehouses_updated_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.warehouses
    ADD CONSTRAINT warehouses_updated_user_id_fkey FOREIGN KEY (updated_user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: warehouses_materials; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.warehouses_materials ENABLE ROW LEVEL SECURITY;

--
-- Name: cfg_materials_statuses; Type: TABLE; Schema: public; Owner: -
--
...
ALTER TABLE public.cfg_materials_statuses OWNER TO postgres;

--
-- Name: cfg_materials_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cfg_materials_statuses; Type: ROW SECURITY; Schema: public; Owner: -
--
