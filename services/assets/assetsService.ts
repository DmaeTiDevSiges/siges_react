...
export const assetsService = {
    ...
    async getAssets(filter: 'all' | 'active' | 'inactive' = 'all', search: string = '', unitId?: string, unitAssetTagId?: string): Promise<Asset[]> {
        try {
            ...
            return data.map((item: any) => ({
                ...
                tagSubName: item.tag_sub_description || item.asset_tag_sub_description || '',
    ...
    async getAssetById(id: string): Promise<Asset | null> {
        ...
        return {
            ...
            tagName: data.tag_name || data.tag_description || data.asset_tag_description || '',
            tagSubId: data.tag_sub_id?.toString(),
            tagSubName: data.tag_sub_description || data.asset_tag_sub_description || '',
